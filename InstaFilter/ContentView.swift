...
struct ContentView: View {
   ...
   /* func loadImage() {
        let inputImage = UIImage(resource: .luiz)
        let beginImage = CIImage(image: inputImage)
   ...
   /* func loadImage() {
    ...
    var body: some View {
//        ShareLink(item: URL(string: "https://www.hackingwithswift.com")!, subject:
//          Text("Lear Swift here"), message: Text("Check out rhe 100 Days of SwiftUI")
//        ShareLink(item: URL(string: "https://www.hackingwithswift.com")!) {
//            Label("Spread the word about Swift", systemImage: "swift")
//        }
        let example = Image(.luiz)
        
        ShareLink(item: example, preview: SharePreview("Singapore Airport", image: example)) {
            Label("clik to shared", systemImage: "airplane")
        }
    }*/
